...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260502184444_AddPorcentajeAplicadoToPago")]
    partial class AddPorcentajeAplicadoToPago
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entidades.Auditoria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Core.Entidades.Pago", b =>
                {
                    ...
                    b.Property<decimal?>("PorcentajeTerapeutaAplicado")
            ...
            modelBuilder.Entity("Core.Entidades.Sesion", b =>
                {
                    ...
                    b.HasOne("Core.Entidades.Turno", "Turno")
                        .WithOne("Sesion")
                        .HasForeignKey("Core.Entidades.Sesion", "TurnoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.Entidades.Turno", b =>
                {
                    ...
                    b.HasOne("Core.Entidades.Usuario", "Terapeuta")
                        .WithMany()
